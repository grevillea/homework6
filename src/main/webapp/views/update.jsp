...
<body>
<form action="/register/update" method="post" id="main_form">
    <input type="text" name="j_name"
           placeholder=姓名 maxlength="11"  style="border-radius: 4px; outline:none;
                           ;width: 300px;height: 35px;text-indent: 10px" value="${members.name}"/><br/>
    <input type="text" name="j_mail"
           placeholder=邮箱 maxlength="20"  style="border-radius: 4px; outline:none;
                           ;width: 300px;height: 35px;text-indent: 10px" value="${members.mail}"/><br/>
    <input type="text" name="j_username"
           placeholder=用户名 maxlength="11"  style="border-radius: 4px; outline:none;
                           ;width: 300px;height: 35px;text-indent: 10px" value="${members.userName}"/><br/>
    <input type="password" name="j_password"
           placeholder=密码 maxlength="11"  style="border-radius: 4px; outline:none;
                           ;width: 300px;height: 35px;text-indent: 10px" value="${members.password}"/><br/>
    <input type="password" name="j_password"
           placeholder=再次输入密码 maxlength="11"  style="border-radius: 4px; outline:none;
    ...
    <input type="submit" id="register"
           style="width: 305px;height: 45px;background-color: orange" value="更新"
